...
Original file is located at
    https://colab.research.google.com/drive/1Ks9T6wnNvm6CW9h-9YJFsOK0Tc6XYOAB
"""
...
def menu_awal():
    while(True):
        print("        Selamat Datang di Perpustakaan UTY01           ")
        print("------------------------------------------------------")
        ...
        try:
            ...
            if(a==1):
                ...
                print("Terimakasih telah menggunakan sistem perpustakaan UTY01")
                break
            else:
